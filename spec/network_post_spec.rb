...
describe Google::Resourcemanager::Network::Post do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Resourcemanager::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Resourcemanager::NetworkBlocker.instance.allow_post(
  ...
  context 'failed request' do
    before(:each) { Google::Resourcemanager::NetworkBlocker.instance.deny(uri_in) }
